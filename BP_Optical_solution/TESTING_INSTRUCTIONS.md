...
This document outlines the steps to verify the functionality of the `BP_Optical_solution` module, which allows paying customer invoices directly from the Point of Sale.
