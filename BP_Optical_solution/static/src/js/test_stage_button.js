...
import { TestViewPopup } from "@BP_Optical_solution/js/test_view_popup";

export class TestStageButton extends Component {
    static template = "BP_Optical_solution.TestStageButton";
...
class TestSelectionPopup extends AbstractAwaitablePopup {
    static template = "BP_Optical_solution.TestSelectionPopup";
