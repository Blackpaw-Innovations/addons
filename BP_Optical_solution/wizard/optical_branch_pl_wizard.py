...
class OpticalBranchPLWizard(models.TransientModel):
    ...
    def action_print_report(self):
        ...
        return self.env.ref('BP_Optical_solution.action_report_optical_branch_pl').report_action(self, data=data)

class ReportOpticalBranchPL(models.AbstractModel):
    _name = "report.bp_optical_solution.report_optical_branch_pl"
