...
export class BpHrDashboard extends Component {
    static template = "bp_role_dashboards.HrDashboard";
    ...
    async load() {
        ...
        try {
            const data = await this.orm.call("bp.hr.dashboard", "get_dashboard_data", [], {});
            this.state.data = data;
        } catch (e) {
            this.notification.add("Could not load HR Dashboard.", { type: "danger" });
        } finally {
...
registry.category("actions").add("bp_dash_hr", BpHrDashboard);
